<script type="module">
import three from 'https://cdn.skypack.dev/three@0.146.0';
</script>
...
import { OrbitControls } from 'https://cdn.skypack.dev/three@0.146.0/examples/jsm/controls/OrbitControls.js
';

// import GLTF loader
import { GLTFLoader } from 'https://cdn.skypack.dev/three@0.146.0/addons/loaders/GLTFLoader.js';
...
var object;
loader.load( 'https://storage.googleapis.com/tom-clover/dog.glb', function (gltf) {
  object = gltf.scene;
